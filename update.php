...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE usuarios SET nome='$nome', email='$email', telefone='$telefone' WHERE id=$id"; // Prepara a atualização
...
<body>
    ...
    <form action="" method="POST">
        ...
        <input type="telefone" name="telefone" value="<?php echo $usuario['telefone']; ?>" required>
